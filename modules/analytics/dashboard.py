...
dashboard_config = {
    ...
    'save_html_path': "./visualization/dashboard/assets/html/",
...
def sync_to_npm(simul_configs):
    ...
    config_data = {
        "TIME_RANGE_START": simul_configs['time_range'][0],
        "TIME_RANGE_END": simul_configs['time_range'][1],
        "NUM_TAXIS": simul_configs.get('num_taxis', None),
        "BASE_DATE": simul_configs.get('base_date', None)
    }
